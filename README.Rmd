...
## DGThemes, some test text for github actions
...
ggplot(mtcars, aes(mpg, wt)) +
  ...
  labs(x="Fuel efficiency (mpg)", y="Weight (tons)",
       ...
       subtitle="The more a car weighs, the less fuel efficiency it tends to have",
       caption="Data from the `mtcars` package") + 
  theme_premium_rc()
```
