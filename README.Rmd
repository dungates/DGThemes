...
# DGThemes::import_tisa_sans()
systemfonts::register_font("Tisa Sans Pro", plain = "/Users/dunk/Library/Fonts/TisaSansPro-Regular.ttf")
systemfonts::register_font("Open Sans", plain = "/Users/dunk/Library/Fonts/OpenSans-Regular.ttf
")
systemfonts::register_font("Fira Sans", plain = "/Users/dunk/Library/Fonts/FiraSans-Regular.ttf")
```
...
ggplot2::ggplot(HairEyeColor) +
  geom_boxplot(ggplot2::aes(x = Eye, y = n, color = Sex)) +
...
ggplot2::ggplot(tophitters2001, ggplot2::aes(hr, so, color = lg)) +
  ...
  ggplot2::geom_text(ggplot2::aes(label = if_else(hr > 50, name, NULL)),
    vjust = 1.2
  ) +
  DGThemes::scale_color_premium() +
  theme_premium() +
...
tophitters2001 %>%
  ...
  dplyr::slice(c(1:10)) %>%
  ggplot2::ggplot(ggplot2::aes(fct_reorder(name, pct), pct)) +
  ggplot2::geom_col() +
