...
#' @export
premium <- function(number_sections = FALSE,
                  fig_width = 7,
                  fig_height = 5,
  ...
  dep <- htmltools::htmlDependency(
    name = "premium",
    version = "0.1.0",
    system.file("rmarkdown", "templates", "premium", "resources", package = "DGThemes"),
    # script="rainbow-custom.min.js",
    stylesheet="premium.css"
  )
  ...
  args <- c(
    ...
    rmarkdown::pandoc_path_arg(
      system.file("rmarkdown", "templates", "premium", "base.html", package = "DGThemes")
    )
  )
