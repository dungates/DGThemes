...
#'
#' @md
#' @section Why Open Sans?:
#' First and foremost, Open Sans is generally installed by default or readily
...
#'
#' @section Building upon `theme_duncan`:
...
#' }
theme_duncan <- function(base_family = "Open Sans",
                         base_size = 11.5,
                         plot_title_family = "Fira Sans",
                         plot_title_size = 18,
                         plot_title_face = "bold",
                         plot_title_margin = 10,
                         subtitle_family = "Fira Sans",
                         subtitle_size = 12,
                         subtitle_face = "plain",
                         subtitle_margin = 15,
